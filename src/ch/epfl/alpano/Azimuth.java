...
public interface Azimuth
{
    ...
    {
        Preconditions.checkArgument(isCanonical(azimuth), "The azimuth must be canonical.");
    ...
    {
        Preconditions.checkArgument(isCanonical(azimuth), "The specified azimuth is not canonical.");
